...
static int ex,ey,bx,by,cx,cy,tx,ty,Drawing=0;
static bool M=0,K=0;
...
public:
		...
		void up()
		{
			Rectangle(memDC,p->val1+ex-bx,p->val2+ey-by,p->val3+ex-bx,p->val4+ey-by);
			p->val1=p->val1+ex-bx;
			p->val2=p->val2+ey-by;
			p->val3=p->val3+ex-bx;
			p->val4=p->val4+ey-by;
		...
		void move()
		{
			Rectangle(hdc,p->val1+cx-bx,p->val2+cy-by,p->val3+cx-bx,p->val4+cy-by);
		}
...
public:
		...
		void up()
		{
			Ellipse(memDC,p->val1+ex-bx,p->val2+ey-by,p->val3+ex-bx,p->val4+ey-by);
			p->val1=p->val1+ex-bx;
			p->val2=p->val2+ey-by;
			p->val3=p->val3+ex-bx;
			p->val4=p->val4+ey-by;
		...
		void move()
		{
			Ellipse(hdc,p->val1+cx-bx,p->val2+cy-by,p->val3+cx-bx,p->val4+cy-by);
		}
...
public:
		...
		void move()
		{
			MoveToEx(hdc,p->val1+cx-bx,p->val2+cy-by,NULL);
			LineTo(hdc,p->next->val3+cx-bx,p->next->val4+cy-by);
			MoveToEx(hdc,p->val1+cx-bx,p->val2+cy-by,NULL);
			LineTo(hdc,p->next->val1+cx-bx,p->next->val2+cy-by);
			MoveToEx(hdc,p->next->val3+cx-bx,p->next->val4+cy-by,NULL);
			LineTo(hdc,p->next->val1+cx-bx,p->next->val2+cy-by);
		}
		...
		void up()
		{
				p->val1=p->val1+ex-bx;
				p->val2=p->val2+ey-by;
				p->next->val1=p->next->val1+ex-bx;
				p->next->val2=p->next->val2+ey-by;
				p->next->val3=p->next->val3+ex-bx;
				p->next->val4=p->next->val4+ey-by;
				MoveToEx(memDC,p->val1,p->val2,NULL);
				LineTo(memDC,p->next->val1,p->next->val2);
				MoveToEx(memDC,p->next->val1,p->next->val2,NULL);
				LineTo(memDC,p->next->val3,p->next->val4);
...
public:
		...
		virtual void ButtonDown(int,int)=0;
...
//			triangle.CreateButton(pop1);
		...
		/*	if (Drawing==1)
			...
			while(p!=NULL)
			{
			/*	if((bx>p->val1&&bx<p->val3||bx<p->val1&&bx>p->val3)&&(by>p->val2&&by<p->val4||by<p->val2&&by>p->val4)&&(by==(p->val4-p->val2)/(p->val3-p->val1)*(bx-p->val1)+p->val2)&&p->val5=='l')
				{				
					K=1;
					break;
				}*/
				if(((bx>p->val1&&bx<p->val3)||(bx<p->val1&&bx>p->val3))&&((by>p->val2&&by<p->val4)||(by<p->val2&&by>p->val4))&&p->val5=='r')
				{
					K=1;
				...
				else if(((bx>p->val1&&bx<p->val3)||(bx<p->val1&&bx>p->val3))&&((by>p->val2&&by<p->val4)||(by<p->val2&&by>p->val4))&&p->val5=='c')
				{
					K=1;
			...
			/*	else if(p->val5=='t'&&p->next->val5=='0')
				{
					S1=Striangle(bx,by,p->val1,p->val2,p->next->val1,p->next->val2);
					S2=Striangle(bx,by,p->next->val1,p->next->val2,p->next->val3,p->next->val4);
					S3=Striangle(bx,by,p->val1,p->val2,p->next->val3,p->next->val4);
